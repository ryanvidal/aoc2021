...
public class Day4Solver: DailySolver {
    public typealias CalculationInput = Day4Data
...
extension Day4Solver {
    public class Day4Data {
        ...
        public func findLastBoardScore() -> Double? {
            ...
            while (!numbers.isEmpty) {
                ...
                for board in boards {
                    if !board.haveWon, let score = board.markNumber(calledNumber) {
                        finalScore = score
                    }
                }
    ...
    public class BingoBoard {
        ...
        init(numbers: [[Int]]) {
            board = numbers.map { row in row.map(Space.init) }
            spaces = [:]
        ...
        public var haveWon: Bool {
            ...
            // Check columns by transposing matrix
            ...
            // Check diagonals, assuming square
            if board.diagonal(order: board.count).allSatisfy({ $0.marked }) {
                return true
            }
